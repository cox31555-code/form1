                  ...
                  {showDropdown && (
                    <div className="relative w-[calc(11.111%-0.1875rem)] flex-shrink-0">
                      <button
                        ...
                        className="w-full h-10 border border-gray-200 rounded-lg flex items-center justify-center hover:border-blue-400 hover:bg-white transition-all duration-200 text-gray-600 hover:text-gray-900 leading-none p-0"
                      >
